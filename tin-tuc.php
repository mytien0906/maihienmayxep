                ...
                <div class="container">
                    <ul class="header-navbar-list">
                        ...
                        <li class="header-navbar-item"><a href="gioi-thieu.php" class="header-navbar-link">Giới
                                thiệu</a></li>
                        <li class="header-navbar-item"><a href="cong-trinh.php" class="header-navbar-link">Công
                                trình</a></li>
                        <li class="header-navbar-item"><a href="dich-vu.php" class="header-navbar-link">Dịch vụ</a>
                        </li>
                        <li class="header-navbar-item"><a href="tin-tuc.php" class="header-navbar-link">Tin tức</a>
                        </li>
                        <li class="header-navbar-item"><a href="video.php" class="header-navbar-link">Video</a></li>
                        <li class="header-navbar-item"><a href="lien-he.php" class="header-navbar-link">Liên hệ</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="tin-tuc.php"><span>Tin tức</span></a></li>
                    </ol>
                </div>
            </div>
        </div>
