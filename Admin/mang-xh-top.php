...
$mangxhs = $UserModel->getAllMangXHTop();
 ?>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <a
                        ...
                        <img
                          ...
                          src="./thumb/<?php echo $mangxh['photo'] ?>"
                    ...
                    <td class="align-middle text-center">
                      <div class="custom-control custom-checkbox my-checkbox">
                      <input
                          btn-id="btn-hienthi-<?= $mangxh['id'] ?>"
                          data-id = "<?= $mangxh['id'] ?>"
                          type="checkbox"
                          data-loai="hienthi"
                          <?= $mangxh['hienthi'] == 1 ? "checked" : "" ?>
                        />
                      </div>
                    </td>
                    <td class="align-middle text-center text-md text-nowrap">
                      <a
                        ...
                        href="add_mangxh-top.php?id=<?= md5($mangxh['id'] . "maixep") ?>"
                        title="Chỉnh sửa"
                        ><i class="bi bi-pencil-square"></i></a>
                      <a
                        class="text-danger"
                        id="delete-item"
                        href="delete_mangxh.php?id=<?= md5($mangxh['id'] . "maixep") ?>"
                        title="Xóa"
    ...
    $(document).ready(function(){
      $("[data-id]").click(function(){
          ...
          if ($(this).is(':checked')) {
            ...
            // console.log(id);
            $.ajax({
              url: "dmc1_action_hienthi.php?atc=mangxh",
              method: "POST",
              data:{id:id},
          ...
          var id = $(this).attr('data-id');
            // console.log(id);
            $.ajax({
              url: "dmc1_deletecheck_hienthi.php?atc=mangxh",
              method: "POST",
              data:{id:id},
              success:function(data){
                if(data == 1){
