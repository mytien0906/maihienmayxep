              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  for (var E = 0; E < o.globals.collapsedSeries.length; E++)
                    o.globals.collapsedSeries[E].index === a &&
                      ((P = 1), (s = 0));
                  0 === t && 0 === e && (s = 0),
                    h.animateCircle(
                      v,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !b) {
                ...
                var m = "";
                void 0 !== s &&
                  (m = p(s, { seriesIndex: a, dataPointIndex: r, w: d })),
                  0 === s && d.config.chart.stacked && (m = ""),
                  d.config.chart.stacked &&
                    this.barOptions.dataLabels.hideOverflowingLabels &&
                    (this.isHorizontal
                      ? (((h =
                          this.series[a][r] / this.yRatio[this.yaxisIndex]) >
                          0 &&
                          o.width / 1.6 > h) ||
                          (h < 0 && o.width / 1.6 < h)) &&
                        (m = "")
                      : ((l = this.series[a][r] / this.yRatio[this.yaxisIndex]),
                        o.height / 1.6 > l && (m = "")));
                var v = n({}, c);
                this.isHorizontal &&
                  s < 0 &&
                  ("start" === c.textAnchor
                    ? (v.textAnchor = "end")
                    : "end" === c.textAnchor && (v.textAnchor = "start")),
            ...
            value: function (t, e) {
              ...
              for (
                ...
                for (var M = 0; M < i.globals.dataPoints; M++) {
                  ...
                  this.isHorizontal
                    ? ((T = this.drawBarPaths({
                        indexes: { i: l, j: M, realIndex: w, bc: h },
                        barHeight: L,
                        strokeWidth: C,
                        pathTo: c,
                        pathFrom: u,
            ...
            value: function (t) {
              ...
              for (
                ...
                e.globals.dataChanged &&
                  ...
                  (z =
                    Math.round(
                      (A * d.negToZero(e.globals.previousPaths[m])) / 100
                    ) + k)),
                ...
                !this.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
                  ((X = ((L - w) / 360) * e.config.chart.animations.speed),
                  (this.animDur = X / (1.2 * t.series.length) + this.animDur),
                  this.animBeginArr.push(this.animDur)),
                  e.globals.dataChanged &&
                    ((X =
                      ((L - w) / 360) *
        ...
        s(t, [
          {
            ...
            value: function (t, e, i, s) {
              var a,
                ...
                c = o;
              return (
                (a = new D(this.ctx).xLabelFormat(l, o, c)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.setGridXPosForDualYAxis(n, s),
                new O(this.ctx).setYAxisXPosition(s, n);
            },
          },
          {
        ...
        s(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              var m = t;
              (o = []).push(m);
              for (var v = Math.abs(e - t) / a, y = 0; y <= a; y++)
                (m += v), o.push(m);
              return (
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              ("top" !== t.config.legend.position &&
                "bottom" !== t.config.legend.position) ||
                (i = new B(this.ctx).getLegendBBox().clwh + 10);
              ...
              s &&
                ...
                (a = d.getBoundingClientRect(s).height);
              var n =
                Math.max(a, 2 * t.globals.radialSize) + e.translateY + i + 20;
              e.dom.elLegendForeign &&
                e.dom.elLegendForeign.setAttribute("height", n),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (t.globals.isBarHorizontal) {
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (
                    var M = 0, T = 0, X = t.globals.gridWidth, I = 0;
                    I < o + 1;
                    I++
                  ) {
                    var Y = e.drawLine(
            ...
            value: function (t) {
              ...
              !i.hasBars() || n.globals.comboCharts || i.isBarShared) ||
                (this.tConfig.onDatasetHover.highlightDataSeries &&
                  new W(e).toggleSeriesOnHover(a, a.target.parentNode));
        ...
        s(i, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              var r = { min: e, max: i };
              s.config.chart.zoom.autoScaleYaxis &&
                (n = new _(this.ctx).autoScaleY(this.ctx, n, { xaxis: r }));
              this.ctx._updateOptions(
          ...
          case "A":
            t = (e = (function (t, e) {
              ...
              (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(
                ...
                (s = (i.x * i.x) / (P * P) + (i.y * i.y) / (E * E)) > 1 &&
                  ((s = Math.sqrt(s)), (P *= s), (E *= s));
              (a = new SVG.Matrix()
                .rotate(M)
                .scale(1 / P, 1 / E)
                .rotate(-M)),
          ...
          if ("function" == typeof n) {
            ...
            "object" == typeof n &&
              (null != n.minX && s < n.minX
                ...
                : null != n.maxX &&
                  s > n.maxX - e.width &&
                  (r = (s = n.maxX - e.width) - this.startPoints.box.x),
              null != n.minY && a < n.minY
                ? (o = (a = n.minY) - this.startPoints.box.y)
                : null != n.maxY &&
                  a > n.maxY - e.height &&
                  (o = (a = n.maxY - e.height) - this.startPoints.box.y),
              null != n.snapToGrid &&
                ((s -= s % n.snapToGrid),
                (a -= a % n.snapToGrid),
                (r -= r % n.snapToGrid),
            ...
            return (
              r < s
                ? ((i[1] = a / s - this.parameters.box.height),
                  e && (i[1] = -i[1]))
                : r > s &&
                  ((i[0] = this.parameters.box.width - n * s),
                  e && (i[0] = -i[0])),
              i
            );
          }),
                    ...
                    t.series[0].data &&
                      (t.series = t.series.map(function (t, e) {
                        return n({}, r.config.series[e], {
                          name: t.name
                            ? t.name
                            : r.config.series[e] && r.config.series[e].name,
                          type: t.type
                            ? t.type
                            : r.config.series[e] && r.config.series[e].type,
                          data: t.data
                            ? t.data
                            : r.config.series[e] && r.config.series[e].data,
                        });
                      })),
                        ...
                        ("mousedown" === t.type && 1 === t.which) ||
                          ((("mouseup" === t.type && 1 === t.which) ||
                            ...
                            ("function" == typeof e.config.chart.events.click &&
                              e.config.chart.events.click(t, i, e),
                            i.fireEvent("click", [t, i, e])));
                      },
                      { capture: !1, passive: !0 }
                    );
                  }),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                (s = i.globals.axisCharts
                  ...
                  ? new f(this.ctx).pathMouseDown(s, null)
