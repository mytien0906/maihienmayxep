                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <a
                        ...
                        <img
                          ...
                          src="./thumb/<?php echo $congtrinh['congtrinh_photo'] ?>"
                    ...
                    <td class="align-middle text-center">
                      ...
                      <input
                          ...
                          type="checkbox"
                          data-loai="noibat"
                          btn-id="btn-noibat-<?= $congtrinh['congtrinh_id'] ?>"
                          data-id-noibat="<?= $congtrinh['congtrinh_id'] ?>"
                          <?= $congtrinh['noibat'] == 1 ? "checked" : "" ?>
                        />
                      </div>
                    </td>
                    <td class="align-middle text-center">
                      <div class="custom-control custom-checkbox my-checkbox">
                      <input
                          btn-id="btn-hienthi-<?= $congtrinh['congtrinh_id'] ?>"
                          data-id = "<?= $congtrinh['congtrinh_id'] ?>"
                          type="checkbox"
                          data-loai="hienthi"
                          <?= $congtrinh['hienthi'] == 1 ? "checked" : "" ?>
                        />
                      </div>
                    </td>
                    <td class="align-middle text-center text-md text-nowrap">
                      <a
                        ...
                        href="add_congtrinh.php?congtrinh_id=<?= md5($congtrinh['congtrinh_id'] . "maixep") ?>"
                        title="Chỉnh sửa"
                        ><i class="bi bi-pencil-square"></i></a>
                      <a
                        class="text-danger"
                        id="delete-item"
                        href="delete_congtrinh.php?congtrinh_id=<?= md5($congtrinh['congtrinh_id'] . "maixep") ?>"
                        title="Xóa"
...
$(document).ready(function(){
  $("[data-id]").click(function(){
      ...
      if ($(this).is(':checked')) {
        ...
        // console.log(id);
        $.ajax({
          url: "dmc1_action_hienthi.php?atc=congtrinh",
          method: "POST",
          data:{id:id},
      ...
      var id = $(this).attr('data-id');
        // console.log(id);
        $.ajax({
          url: "dmc1_deletecheck_hienthi.php?atc=congtrinh",
          method: "POST",
          data:{id:id},
          success:function(data){
            if(data == 1){
    ...
    $("[data-id-noibat]").click(function(){
      ...
      if ($(this).is(':checked')) {
        ...
        console.log(id);
        $.ajax({
          url: "dmc1_action.php?atc=congtrinh",
          method: "POST",
          data:{id:id},
          success:function(data){
            if(data = 1){
      ...
      // var id = $(this).attr('data-id');
        console.log(id);
        $.ajax({
          url: "dmc1_deletecheck.php?atc=congtrinh",
          method: "POST",
          data:{id:id},
          success:function(data){
            if(data == 1){
