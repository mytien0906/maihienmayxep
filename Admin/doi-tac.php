                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <a
                        ...
                        <img
                          ...
                          src="./thumb/<?php echo $doitac['photo'] ?>"
                    ...
                    <td class="align-middle">
                      <a
                        ...
                        href="index.php?com=product&amp;act=edit_list&amp;type=san-pham&amp;p=1&amp;id=29"
                        title="Cổng xếp tự động"
                        ><?= $doitac['doitac_name'] ?></a
                      >
                    </td>
                    <td class="align-middle text-center">
                      <div class="custom-control custom-checkbox my-checkbox">
                      <input
                          btn-id="btn-hienthi-<?= $doitac['id'] ?>"
                          data-id = "<?= $doitac['id'] ?>"
                          type="checkbox"
                          data-loai="hienthi"
                          <?= $doitac['hienthi'] == 1 ? "checked" : "" ?>
                        />
                      </div>
                    </td>
                    <td class="align-middle text-center text-md text-nowrap">
                      <a
                        ...
                        href="add_doitac.php?id=<?= md5($doitac['id'] . "maixep") ?>"
                        title="Chỉnh sửa"
                        ><i class="bi bi-pencil-square"></i></a>
                      <a
                        class="text-danger"
                        id="delete-item"
                        href="delete_doitac.php?id=<?= md5($doitac['id'] . "maixep") ?>"
                        title="Xóa"
    ...
    $(document).ready(function(){
      $("[data-id]").click(function(){
          ...
          if ($(this).is(':checked')) {
            ...
            // console.log(id);
            $.ajax({
              url: "dmc1_action_hienthi.php?atc=doitac",
              method: "POST",
              data:{id:id},
          ...
          var id = $(this).attr('data-id');
            // console.log(id);
            $.ajax({
              url: "dmc1_deletecheck_hienthi.php?atc=doitac",
              method: "POST",
              data:{id:id},
              success:function(data){
                if(data == 1){
